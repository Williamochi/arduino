...
TridentOS   DHT_task, Blink_task, WiFi_task, AsyncWebServer_task, Windows_Status;
void DHT_func(void*), Blink_func(void*), WiFi_func(void*), AsyncWebServer_func(void*), Windows_status_func(void*);
